export function FacebookIcon({ classes }: { classes: string }) {
  return (
    <svg
...
export function InstagramIcon({ classes }: { classes: string }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 640 640"
...
export function PinterestIcon({ classes }: { classes: string }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 640 640"
...
export function TiktokIcon({ classes }: { classes: string }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 640 640"
...
export function XIcon({ classes }: { classes: string }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 640 640"
...
export function YouTubeIcon({ classes }: { classes: string }) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 640 640"

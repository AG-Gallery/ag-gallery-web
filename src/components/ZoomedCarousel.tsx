  ...
  return (
    ...
    >
      <DialogContent
        ...
        className="inset-0 flex h-full w-full translate-x-0 translate-y-0 items-center justify-center border-none bg-transparent p-0 sm:max-w-none"
      >
        ...
        {hasImages && (
          <div className="relative mx-auto flex h-full w-full max-w-screen flex-col items-center justify-center bg-black px-3 py-6 sm:px-6">
            <Carousel
              images={images}
              enableZoom={false}
